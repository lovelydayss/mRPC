...
PATH_INSTALL_LIB_ROOT = /usr/lib /usr/local/lib

# will install all header file to /usr/include/rocket
PATH_INSTALL_INC_ROOT = /usr/include /usr/local/include
...
LIBS += /usr/local/lib/libprotobuf.so	/usr/local/lib/libtinyxml.so
